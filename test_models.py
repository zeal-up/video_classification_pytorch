...
from models.tsn_model.basic_ops import ConsensusModule
...
print("model epoch {} prec@1: {}".format(checkpoint['epoch'], checkpoint['acc']))

base_dict = {'.'.join(k.split('.')[1:]): v for k,v in list(checkpoint['state_dict'].items())}
net.load_state_dict(base_dict)
## equal to model = torch.nn.DataParallel(model)
