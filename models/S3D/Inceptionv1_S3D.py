...
class InceptionModuleS3D(nn.Module):
    def __init__(self, in_channels, out_channels, name):
        ...
        self.b1b = Unit3D(in_channels=out_channels[1], output_channels=out_channels[2], kernel_shape=[1, 3, 3],
                          name=name+'/Branch_1/Conv3d_0b_3x3')
        self.b1bS = Unit3D(in_channels=in_channels, output_channels=out_channels[2], kernel_shape=[3, 1, 1], padding=0,
                          name=name+'./Branch_1/Conv3d_0b_3x1x1')

        self.b2a = Unit3D(in_channels=in_channels, output_channels=out_channels[3], kernel_shape=[1, 1, 1], padding=0,
                          name=name+'/Branch_2/Conv3d_0a_1x1')
        self.b2b = Unit3D(in_channels=out_channels[3], output_channels=out_channels[4], kernel_shape=[1, 3, 3],
                          name=name+'/Branch_2/Conv3d_0b_3x3')
        self.b2bS = Unit3D(in_channels=in_channels, output_channels=out_channels[4], kernel_shape=[3, 1, 1], padding=0,
                           name=name+'/Branch_2/Conv3d_0b_3x1x1')
